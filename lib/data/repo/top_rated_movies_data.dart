...
class TopRatedMoviesData implements MoviesRepo{
  TopRatedMoviesData(this.moviesApiService);
...
//   return moviesApiService.getMovies(page: page, moviesType: 'top_rated');
// }
